...
<table border="1">
    ...
    <tr>
        <td>名前、メールアドレス、パスワードを入力し、アカウント登録をできます。</td>
        <td>名前、メールアドレス、自己紹介、生年月日等を編集できます。</td>
        <td>投稿、イベント、いいねした投稿等をタブで切り替えて閲覧できます。</td>
        <td>画像とともに、投稿ができます。</td>
        <td>イベントを開催することができます。</td>
    </tr>
</table>
