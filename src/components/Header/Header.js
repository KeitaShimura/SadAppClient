...
import { faBars, faHome, faPowerOff, faUser, faUsers, faVideo } from "@fortawesome/free-solid-svg-icons";
...
const Header = () => {
    ...
    return (
        ...
        <header className={`header ${showMobileMenu ? 'show-mobile-menu' : ''}`}>
            ...
            <FontAwesomeIcon icon={faBars} className="hamburger-menu" onClick={() => setShowMobileMenu(!showMobileMenu)} />
            <div className="mobile-menu">
                ...
                <a href={`/users/${user?.sub}`} onClick={() => setShowMobileMenu(false)}>
                ...
                <a href="" onClick={() => { logout(); setShowMobileMenu(false); }}>
                    <FontAwesomeIcon icon={faPowerOff} />
                    ログアウト
                </a>
                <Button onClick={() => { setShowPostModal(true); setShowMobileMenu(false); }}>
                    投稿する
                </Button>
                <Button onClick={() => { setShowEventModal(true); setShowMobileMenu(false); }}>
                    イベントを投稿する
                </Button>
            </div>
